            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('tutor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>tutor</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    {hasAccess('tutor', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/tutors/view/${record.tutor?.id}`}>
                          {record.tutor?.skills}
                        </Link>
                      </Td>
                    )}
